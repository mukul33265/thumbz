    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm/7 mt-2">
            AI-powered thumbnail generator for YouTube creators. Create
            stunning, eye-catching thumbnails in seconds with our advanced AI
            technology.
          </p>
        </div>
      ...
      <p className="py-4 text-center border-t mt-6 border-slate-700">
        Copyright 2025 © Thumbz. All Rights Reserved.
      </p>
    </motion.footer>
  );
}
